...
export default function ReelsShortsMotionPage() {
  // Get the specific subcategory data
  const subcategoryData = {
    ...reelsEditingServices,
    subCategories: [reelsEditingServices.subCategories[2]] // Only show the Motion Graphics subcategory
  };
      ...
      <section className="py-12 bg-zinc-900/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <Link 
              href="/services/video-editing/reels-shorts/basics"
            ...
            >
              ...
              <p className="text-gray-400">Essential editing for Reels and Shorts including cuts, transitions, and basic effects.</p>
            </Link>
