...
export default function SocialMediaCopywritingPage() {
  // Get the specific subcategory data
  const subcategoryData = {
    ...copywritingServices,
    subCategories: [copywritingServices.subCategories[3]] // Only show the Social Media subcategory
  };
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-400">Search engine optimized content that ranks and converts.</p>
            </Link>
