...
import { contentMarketingServices } from '../../../../data/servicesData';
...
export default function ContentMarketingPage() {
  return (
    <main className="min-h-screen bg-black">
      ...
      <ServiceCategoryView serviceData={contentMarketingServices} />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-400">Strategic social media campaigns to grow your audience and engagement.</p>
            </Link>
          </div>
        </div>
      </section>
